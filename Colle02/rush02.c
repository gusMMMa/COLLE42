...
/*   Updated: 2017/07/23 14:13:31 by egrout-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*rush02(int x, int y)
{
	...
	if (x > 0 && y > 0)
	{
		ft_line_border(x, 'A', 'A', line_first);
		ft_line_border(x, 'B', 'B', line_middle);
		ft_line_border(x, 'C', 'C', line_last);
		ft_line_center(x, 'B', line_first);
		ft_line_center(x, ' ', line_middle);
		ft_line_center(x, 'B', line_last);

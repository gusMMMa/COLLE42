...
/*   Updated: 2017/07/23 19:14:50 by egrout-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	{
		ft_line_border(ft_atoi(argv[1]), 'o', 'o', line_first);
		ft_line_border(ft_atoi(argv[1]), '|', '|', line_middle);
		ft_line_border(ft_atoi(argv[1]), 'o', 'o', line_last);
		ft_line_center(ft_atoi(argv[1]), '-', line_first);
		ft_line_center(ft_atoi(argv[1]), ' ', line_middle);
		ft_line_center(ft_atoi(argv[1]), '-', line_last);
